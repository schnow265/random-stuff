...
class Window() :
  ...
  def __init__(self, Titel, Text, But1, But2) :
    ...
    self.Anzeige = Label(self.Fenster, text=Text)
    self.Anzeige.place(x=50, y=20, width=160, height=30)
    self.Button1 = Button(self.Fenster, text=But1, command=self.button1Click)
    self.Button2 = Button(self.Fenster, text=But2, command=self.button2Click)
...
# Hauptprogramm
Fenster = Window("Hallo", "Wie geht es?", "Gut", "Schlecht")
